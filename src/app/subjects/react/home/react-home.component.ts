...
@Component({
  ...
  styles: [`
    ...
    .landing-bg {
      background-image:
        radial-gradient(circle at 18% 12%, rgba(8, 145, 178, 0.16) 0%, transparent 38%),
        radial-gradient(circle at 82% 88%, rgba(6, 182, 212, 0.14) 0%, transparent 42%);
    }
    .landing-grid {
      background-image:
    ...
    .eyebrow {
      ...
      font-size: 0.75rem; letter-spacing: 0.16em; color: #67e8f9;
    ...
    .sec-label {
      ...
      font-family: 'JetBrains Mono', ui-monospace, monospace;
      font-size: 0.75rem; letter-spacing: 0.14em; color: #67e8f9;
      text-transform: uppercase; margin: 0 0 0.5rem; font-weight: 600;
    }
    .sec-label::before {
      content: ''; display: inline-block;
      width: 36px; height: 1px; background: rgba(103, 232, 249, 0.5);
    }
    .sec-title {
